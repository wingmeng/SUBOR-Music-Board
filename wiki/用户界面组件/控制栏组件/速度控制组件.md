...
Sequencer->>MusicEngine : stopFrom(cutoffTime)
MusicEngine-->>Sequencer : 停止未来音符
Sequencer->>MusicEngine : scheduleAllNotes(startColumn)
...
CheckPlaying --> |播放中| Reschedule[重新调度]
Reschedule --> StopFuture[停止未来音符]
StopFuture --> ScheduleNew[重新调度音符]
...
1. **选择性停止机制**：当调整 BPM 时，只停止未来的音符，避免影响当前正在播放的音符
...
2. **高效的性能表现**：通过选择性停止和预调度机制优化了实时性能
